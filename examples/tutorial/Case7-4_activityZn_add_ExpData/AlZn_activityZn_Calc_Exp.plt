...
set xlabel "x(ZN)"
set xtics  font "Arial Normal,12"
set ylabel "Activity of ZN,"
set ytics  font "Arial Normal,12"
set label "~O{.0  C}" at screen 0.02, 0.03 font "Garamond Bold,20"
set key top left font "Arial Normal,11"
...
7 0.9569 0.9531
EOD
plot for [i=3: 3] $OCT220730211858 using 2:i with lines ls (i-2+ 0) title columnheader(i),for [i=3: 3] $newdata using 2:i with points ls (4) title "Exp"
set term wxt title 'AlZn_activityZn_Calc_Exp'
pause -1
